...
public class Document implements Serializable{
    ...
    public Document crear(SystemUser systemUser, Category category, Author author, Editorial editorial, Lenguaje lenguaje){
    ...
    public Document modified(Document body, SystemUser systemUser, Category category, Author author, Editorial editorial, Lenguaje lenguaje) {
    ...
    public Document(int documentId, String title, String description, String imagenPath, String pdfPath, int privated, int userId, int categoryId, int authorId, int editorialId, int lenguajeId, SystemUser systemUser, Category category, Author author, Editorial editorial, Lenguaje lenguaje, Date publicationDate, int state, Date createdOn, String createdUser, Date modifiedOn, String modifiedUser) {
    ...
    public Document systemUser(SystemUser systemUser) {
        this.systemUser = systemUser;
        return this;
    }
